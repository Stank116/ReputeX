...
use crate::constants::{
    DEFAULT_FUNDING_INTERVAL_SLOTS, DEFAULT_INITIAL_MARGIN_BPS, DEFAULT_LIQUIDATION_FEE_BPS,
    DEFAULT_MAINTENANCE_MARGIN_BPS, DEFAULT_MAX_FUNDING_RATE_BPS, DEFAULT_MAX_OPEN_INTEREST,
    DEFAULT_MAX_SKEW_BPS, DEFAULT_ORACLE_MAX_AGE_SECONDS, DEFAULT_ORACLE_MAX_CONFIDENCE_BPS,
...
pub fn handler(
    ...
    market.initial_margin_bps = DEFAULT_INITIAL_MARGIN_BPS;
